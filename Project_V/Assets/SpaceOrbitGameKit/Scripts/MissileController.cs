...
public class MissileController : MonoBehaviour {
	...
	void Update () {
        ...
        //GetComponent <Rigidbody>().AddRelativeForce(target.transform.right * (1 + (GameController.level/1000)));
        //transform.Translate(target.transform.right * missileSpeed * (1 + (GameController.level / 5)), Space.World);.

...
public class Tabligh : MonoBehaviour {
    string TOKEN = "WISVMG4VQZHADM5N52UFU9W3A6NKNF";
  public  string UNIT_CODE  ="6CD79CE5B6F80ECF7C1061F76A9794";
    ...
    private void OnAdResult(AdResult result, string token)
    {
        ...
        switch (result)
        {
            case AdResult.BAD_TOKEN_USED: message += "Bad Token Used"; TaplighInterface.Instance.InitializeTapligh(TOKEN);  break;
            case AdResult.INTERNAL_ERROR: message += "Internal Error"; TaplighInterface.Instance.InitializeTapligh(TOKEN); break;
    ...
    private void OnVerifyListener(TokenResult tokenResult)
    {
        ...
        switch (tokenResult)
        {
            ...
            case TokenResult.SUCCESS: verifiedToken.text += "SUCCESS"; Finish_Panel.gameObject.SetActive(false); But_Res.SetActive(true);  break;
